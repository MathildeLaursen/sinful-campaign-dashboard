/* ===========================================
   CLASSY UNICORN TEMA - Streamlit Dashboard
   =========================================== */
...
/* Fjern luft i toppen af hovedvinduet */
.block-container {
    padding-top: 1rem;
    padding-bottom: 5rem;
}
...
/* Gør sidebaren smallere med gradient */
...
div[data-testid="stCheckbox"] div[data-testid="stMarkdownContainer"] p {
    ...
    line-height: 1.2 !important;
    position: relative !important;
    top: 2px !important; /* Finjustering nedad */
}
...
/* Skjul "Choose a date range" dropdown i kalender - AGGRESSIV */
[data-baseweb="datepicker"] [data-baseweb="select"],
[data-baseweb="datepicker"] > div > div:last-child,
[data-baseweb="calendar"] + div,
div[data-baseweb="popover"] [data-baseweb="select"],
/* Skjul alt under kalenderen */
[data-baseweb="datepicker"] > div:nth-child(2),
[data-baseweb="calendar"] ~ *,
/* Target specifikt "Choose a date range" teksten */
[data-baseweb="datepicker"] div:has(> [data-baseweb="select"]),
[data-baseweb="datepicker"] [role="listbox"],
[data-baseweb="datepicker"] label,
/* Skjul select container under calendar */
[data-baseweb="popover"] > div > div > div:last-child:not([data-baseweb="calendar"]) {
